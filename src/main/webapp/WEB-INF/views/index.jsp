...
<body onload="loaded();">
	<div class="container">
		...
		<div class="btn-toolbar">
			...
			<div class="btn-group">
				<button class="btn btn-primary" data-toggle="modal" href="#cassandraClient"><i class="icon-refresh icon-white"></i> Setup Cassandra client</button>
			</div>
		</div>
	...
	function setupAutoRefresh() {
		$("#autoRefresh").click(function() {
			...
			$("#autoRefresh").html(autoRefresh 
								...
								: "<i class='icon-repeat icon-white'></i> Enable Auto-refresh");
		});
	}
